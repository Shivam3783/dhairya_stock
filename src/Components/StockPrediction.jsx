...
//   // Fetch prediction and filtered stock data
...
//     try {
//         console.log("url",import.meta.env.VITE_MODEL_BASE_URL)
...
//       // Assuming the backend returns filtered stock data as part of the response
//       // Adjust this based on your actual backend response structure
//       const filteredData = data.filtered_data || [];
//       setFilteredStockData(filteredData.map(item => ({
//         date: item.date,
...
//       datasets: [
//         {
//           label: `Predicted Price (${predictionData.symbol})`,
...
//  ation            className="w-full bg-emerald-500 text-white py-2 px-4 rounded-lg hover:bg-emerald-600 transition-colors"
...
//                   <p className="text-white/60 mt-2">Confidence: {(predictionData.confidence * 100).toFixed(2)}%</p>
//                 )}
//               </div>
//             </div>
//           ) : (
//             <div className="h-64 flex items-center justify-center text-white/60">
//               Enter details and click "Get Prediction" to see the forecast.
//             </div>
//           )}
